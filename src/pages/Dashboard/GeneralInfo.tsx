...
export const GeneralInfo = ({ myBalance, myNFTs, myLHC }) => {
  return (
    <div className="flex my-6 items-center w-full space-y-4 md:space-x-4 md:space-y-0 flex-col md:flex-row">
        ...
        <div className="shadow-lg w-full bg-white dark:bg-gray-700 relative overflow-hidden">
          <a href="#" className="w-full h-full block">
            ...
            <div className="w-full h-3 bg-gray-100">
              <div className="w-2/5 h-full text-center text-xs text-white bg-main"></div>
            </div>
          </a>
        </div>
      </div>
      <div className="flex items-center w-full md:w-1/2 space-x-4">
        ...
        <div className="w-1/2">
          <div className="shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 relative">
            <p className="text-2xl text-black dark:text-white font-bold">{myBalance ?? 0} ETH</p>
            <p className="text-gray-400 text-sm">Your ETH Balance</p>
